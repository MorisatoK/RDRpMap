  ...
  updateMarkerContent() {
    ...
    if (Settings.isPinsEditingEnabled) {
      ...
      const markerIcons = [
        ...
        'blip_animal_skin', 'blip_animal', 'blip_ball', 'blip_bath_house', 'blip_bolt', 'blip_campfire_full',
        'blip_campfire', 'blip_cash_bag', 'blip_chest', 'blip_code_waypoint', 'blip_deadeye_cross',
