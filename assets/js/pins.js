  ...
  updateMarkerContent() {
    ...
    if (Settings.isPinsEditingEnabled) {
      ...
      const markerIcons = [
        ...
        'blip_ambient_delivery', 'blip_ambient_eyewitness', 'blip_ambient_gang_leader', 'blip_ambient_herd', 
        'blip_ambient_herd_straggler', 'blip_ambient_hitching_post', 'blip_ambient_horse', 
        'blip_ambient_hot_target', 'blip_ambient_hunter', 'blip_ambient_king', 'blip_ambient_law', 
        'blip_ambient_loan_shark', 'blip_ambient_marked_for_death', 'blip_ambient_newspaper', 
        'blip_ambient_ped_downed', 'blip_ambient_posse_deputy', 'blip_ambient_posse_leader', 
        'blip_ambient_quartermaster', 'blip_ambient_riverboat', 'blip_ambient_secret', 'blip_ambient_telegraph', 
        'blip_ambient_theatre', 'blip_ambient_tithing', 'blip_ambient_train', 'blip_ambient_tugboat', 
        'blip_ambient_vip', 'blip_ambient_wagon', 'blip_ambient_warp', 'blip_animal', 'blip_animal_quality_01', 
        'blip_animal_quality_02', 'blip_animal_quality_03', 'blip_animal_skin', 'blip_ball', 'blip_bath_house', 
        'blip_bolt', 'blip_campfire', 'blip_campfire_full', 'blip_cash_bag', 'blip_chest', 'blip_code_waypoint', 
        'blip_deadeye_cross', 'blip_donate_food', 'blip_event_appleseed', 'blip_event_castor', 
        'blip_event_railroad_camp', 'blip_event_riggs_camp', 'blip_fence_building', 'blip_grub', 'blip_hat', 
        'blip_health', 'blip_hire_camp_follower', 'blip_horse_owned', 'blip_hotel_bed', 'blip_job_board', 
        'blip_mg_blackjack', 'blip_mg_dominoes', 'blip_mg_drinking', 'blip_mg_five_finger_fillet', 
        'blip_mg_poker', 'blip_moonshine', 'blip_moonshine_still', 'blip_moonshine_vat', 'blip_mp_attack_target', 
        'blip_mp_base', 'blip_mp_base_1', 'blip_mp_bounty_hunter_introduction', 'blip_mp_butcher_table', 
        'blip_mp_collector_map', 'blip_mp_deadeye', 'blip_mp_defend_target', 'blip_mp_deliver_target', 
        'blip_mp_flag', 'blip_mp_game_animal_protection', 'blip_mp_game_hill', 'blip_mp_game_race_canoe', 
        'blip_mp_game_race_horse', 'blip_mp_game_runaway_train', 'blip_mp_game_treasure_hunt', 
        'blip_mp_game_vip', 'blip_mp_location_a', 'blip_mp_location_b', 'blip_mp_location_c', 
        ...
        'blip_mp_playstyle_defensive', 'blip_mp_playstyle_offensive', 'blip_mp_predator_hunt_mask', 
        'blip_mp_roundup', 'blip_mp_spawnpoint', 'blip_mp_spawnpoint_arrow', 'blip_mp_torch', 
        'blip_mp_trader_introduction', 'blip_mp_travelling_saleswoman', 'blip_mp_ugc', 'blip_mp_wreckage', 
        'blip_mvp', 'blip_photo_studio', 'blip_plant', 'blip_player', 'blip_player_coach', 'blip_post_office', 
        'blip_post_office_rec', 'blip_predator', 'blip_proc_bank', 'blip_proc_home', 'blip_proc_home_locked', 
        'blip_product_moonshine', 'blip_radius_search', 'blip_region_caravan', 'blip_region_hideout', 
        'blip_saddle', 'blip_saloon', 'blip_shop_animal_trapper', 'blip_shop_barber', 'blip_shop_blacksmith', 
        'blip_shop_butcher', 'blip_shop_doctor', 'blip_shop_gunsmith', 'blip_shop_honor', 'blip_shop_horse', 
        'blip_shop_market_stall', 'blip_shop_shady_store', 'blip_shop_store', 'blip_shop_tackle', 
        'blip_shop_tailor', 'blip_shop_train', 'blip_shop_wardrobe', 'blip_special_series_1', 'blip_stable', 
        'blip_summer_cow', 'blip_summer_feed', 'blip_summer_guard', 'blip_summer_horse', 'blip_supplies_ammo', 
        'blip_supplies_food', 'blip_supplies_health', 'blip_taxidermist', 'blip_teamsters', 'blip_trophy', 
        'blip_wanted_poster'
      ];
